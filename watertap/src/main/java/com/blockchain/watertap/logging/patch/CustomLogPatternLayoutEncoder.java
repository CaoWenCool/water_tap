 ...
 */
public class CustomLogPatternLayoutEncoder extends PatternLayoutEncoderBase<ILoggingEvent> {
    ...
    @Override
    public void start() {
        CustomLogPatternLayout patternLayout = new CustomLogPatternLayout();
