...
public class ApiResult<T> implements Serializable {
    ...
    public  static ApiResult result(ApiCodeGemu apiCodeGemu,Object data,String language){
        return result(apiCodeGemu,null,data,language);
    }

    public  static ApiResult result(ApiCodeGemu apiCodeGemu,String language){
        return result(apiCodeGemu,null,language);
    }
...
//    }
    ...
    public static ApiResult result(ApiCodeGemu apiCodeGemu,String msg,Object data,String language){
        String message = apiCodeGemu.getMessage(apiCodeGemu.getCode(),language);
        if (StringUtils.isNotBlank(msg)){
            message = msg;
        }
        return ApiResult.builder()
                .code(apiCodeGemu.getCode())
                .msg(message)
                .data(data)
                .time(new Date())
                .build();
...
//    public static ApiResult ok(Object data,String language){
//        return result(ApiCodeGemu.SUCCESS,data,language);
//    }
